        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-custom-red-500">
                <div class="p-6 text-custom-black">
                    <form method="POST" action="{{ route('admin.malaysia.states.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="capital_city" class="block mt-1 w-full" type="text" name="capital_city" :value="old('capital_city')" required />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="ruler_type" name="ruler_type" class="border-gray-300 focus:border-custom-red-500 focus:ring-custom-red-500 rounded-md shadow-sm block mt-1 w-full" required>
                                        ...
                                        <option value="Sultan" {{ old('ruler_type') === 'Sultan' ? 'selected' : '' }}>Sultan</option>
                                        <option value="Raja" {{ old('ruler_type') === 'Raja' ? 'selected' : '' }}>Raja</option>
                                        <option value="Yang di-Pertuan Besar" {{ old('ruler_type') === 'Yang di-Pertuan Besar' ? 'selected' : '' }}>Yang di-Pertuan Besar</option>
                                        <option value="Yang di-Pertuan Agong" {{ old('ruler_type') === 'Yang di-Pertuan Agong' ? 'selected' : '' }}>Yang di-Pertuan Agong</option>
                                        <option value="Governor" {{ old('ruler_type') === 'Governor' ? 'selected' : '' }}>Governor</option>
                                        <option value="None" {{ old('ruler_type') === 'None' ? 'selected' : '' }}>None</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="ruler_title" class="block mt-1 w-full" type="text" name="ruler_title" :value="old('ruler_title')" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="establishment_date" class="block mt-1 w-full" type="date" name="establishment_date" :value="old('establishment_date')" />

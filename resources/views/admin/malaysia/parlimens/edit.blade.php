<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Edit Parliamentary Constituency') }}: {{ $parlimen->code }} - {{ $parlimen->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-custom-red-500">
                <div class="p-6 text-custom-black">
                    <form method="POST" action="{{ route('admin.malaysia.parlimens.update', $parlimen) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', $parlimen->code)" required autofocus />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $parlimen->name)" required />
                                ...
                                <div>
                                    ...
                                    <select id="state_id" name="state_id" class="border-gray-300 focus:border-custom-red-500 focus:ring-custom-red-500 rounded-md shadow-sm block mt-1 w-full" required>
                                        ...
                                        @foreach($states as $id => $stateName)
                                            <option value="{{ $id }}" {{ old('state_id', $parlimen->state_id) == $id ? 'selected' : '' }}>{{ $stateName }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="mp_name" class="block mt-1 w-full" type="text" name="mp_name" :value="old('mp_name', $parlimen->mp_name)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="mp_party" class="block mt-1 w-full" type="text" name="mp_party" :value="old('mp_party', $parlimen->mp_party)" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="electorate_count" class="block mt-1 w-full" type="number" name="electorate_count" :value="old('electorate_count', $parlimen->electorate_count)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="last_election_date" class="block mt-1 w-full" type="date" name="last_election_date" :value="old('last_election_date', $parlimen->last_election_date ? $parlimen->last_election_date->format('Y-m-d') : null)" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="creation_date" class="block mt-1 w-full" type="date" name="creation_date" :value="old('creation_date', $parlimen->creation_date ? $parlimen->creation_date->format('Y-m-d') : null)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="last_redelineation_date" class="block mt-1 w-full" type="date" name="last_redelineation_date" :value="old('last_redelineation_date', $parlimen->last_redelineation_date ? $parlimen->last_redelineation_date->format('Y-m-d') : null)" />

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Edit District') }}: {{ $district->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-custom-red-500">
                <div class="p-6 text-custom-black">
                    <form method="POST" action="{{ route('admin.malaysia.districts.update', $district) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $district->name)" required autofocus />
                                ...
                                <div>
                                    ...
                                    <select id="state_id" name="state_id" class="border-gray-300 focus:border-custom-red-500 focus:ring-custom-red-500 rounded-md shadow-sm block mt-1 w-full" required>
                                        ...
                                        @foreach($states as $id => $stateName)
                                            <option value="{{ $id }}" {{ old('state_id', $district->state_id) == $id ? 'selected' : '' }}>{{ $stateName }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="area_sqkm" class="block mt-1 w-full" type="number" step="0.01" name="area_sqkm" :value="old('area_sqkm', $district->area_sqkm)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="population" class="block mt-1 w-full" type="number" name="population" :value="old('population', $district->population)" />

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Create New State Constituency') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-custom-red-500">
                <div class="p-6 text-custom-black">
                    <form method="POST" action="{{ route('admin.malaysia.duns.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code')" required autofocus placeholder="N.001" />
                                ...
                                <div>
                                    ...
                                    <select id="parlimen_id" name="parlimen_id" class="border-gray-300 focus:border-custom-red-500 focus:ring-custom-red-500 rounded-md shadow-sm block mt-1 w-full" required>
                                        ...
                                        @foreach($parlimens as $id => $parlimentName)
                                            <option value="{{ $id }}" {{ old('parlimen_id') == $id ? 'selected' : '' }}>{{ $parlimentName }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="assemblyperson_name" class="block mt-1 w-full" type="text" name="assemblyperson_name" :value="old('assemblyperson_name')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="assemblyperson_party" class="block mt-1 w-full" type="text" name="assemblyperson_party" :value="old('assemblyperson_party')" />
